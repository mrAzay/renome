...
let gulp = require ('gulp'),
    ...
    uglify = require('gulp-terser'), //то же, что cssmin, только для js
    ...
    gulp.task('default', gulp.parallel('browser-sync', 'watch', 'scss', 'style', 'script', 'minjs', 'html', 'cleanfonts', 'cleanimg', 'images', 'fonts')) //запускает все перечисленные задачи разом